  ...
  await VendorField.bulkCreate([
    {
      ...
      fieldType: "enum",
      options: [
        { label: "DR 20+", value: "DR_20" },
        { label: "DR 30+", value: "DR_30" },
        { label: "DR 40+", value: "DR_40" },
        { label: "DR 50+", value: "DR_50" },
        { label: "DR 60+", value: "DR_60" },
      ],
      required: true,
      sortIndex: 1,
      defaultValue: "DR_20",
    ...
    {
      vendorProductId: 1,
      label: "Domain Specifications",
      slug: "domainSpecifications",
      fieldType: "string",
      required: false,
      sortIndex: 2,
      defaultValue: null,
