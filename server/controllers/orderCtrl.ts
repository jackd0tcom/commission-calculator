...
export default {
      ...
      const orderInclude: object[] = [
        {
          model: User,
          as: "user",
          attributes: ["profilePic", "firstName", "lastName", "userId"],
        },
        {
          model: OrderItem,
          required: false,
  ...
  updateCalculatorOrder: async (req: Request, res: Response) => {
    try {
      console.log("updateCalculatorOrder");
      ...
      const { orderId, clientId, salesPerson } = req.body;
      ...
      await order?.update({ clientId, salesPerson });
  ...
  bulkUpdateOrderItemProduct: async (req: Request, res: Response) => {
    try {
      console.log("bulkUpdateOrderItemProduct");
      ...
      const { items, productType, id } = req.body;
      let newProduct;
